...
nohup ffmpeg -f v4l2 -framerate 10 -video_size 1280x720 -i /dev/video0 -f lavfi -i anullsrc -c:v libx264 -preset ultrafast -maxrate 3000k -bufsize 6000k -pix_fmt yuv420p -g 20 -tune zerolatency -crf 35 -vf "drawtext=textfile=$WEBCAM_LABEL:fontcolor=white:fontsize=48:box=1:boxcolor=black@0.5:boxborderw=5:x=10:y=h-th-10:reload=3" -f flv rtmp://localhost:1935/live &
sleep 5
